...
import itmo.spaceshipservice.handler.DetailSoapFaultDefinitionExceptionResolver;
...
public class WebServiceConfig extends WsConfigurerAdapter {
    ...
    public SoapFaultMappingExceptionResolver exceptionResolver() {
        ...
        errorMappings.setProperty(StarshipNotFoundException.class.getName(), SoapFaultDefinition.SERVER.toString());
    ...
    public DefaultWsdl11Definition defaultWsdl11Definition(XsdSchema schema) {
        ...
        wsdl11Definition.setTargetNamespace("http://itmo/starshipservice");
